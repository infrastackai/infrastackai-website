...
export function HeroPost({
  ...
  return (
    <a
      href={`/blog/${slug}`}
      className="glow-hover mt-8 relative justify-between border border-brand-borders dark:bg-medium-black rounded-2xl bg-brand-white p-3 -outline-offset-2 md:p-4 grid grid-rows-[auto_auto] gap-4 lg:grid-cols-2 lg:grid-rows-1 lg:gap-8 md:rounded-3xl motion-reduce:transition-none mb-2 md:mb-4"
    >
