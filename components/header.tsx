  ...
  return (
    <div
      className={cn(
        ...
        "fixed flex right-8 h-16 p-2 pl-4 pr-4 left-8 top-6 items-center rounded-xl justify-between z-[50]",
    ...
    >
      ...
      {false && (
        <div>
          <Button
            variant="outline"
            className="h-12 bg-violet-500 hover:bg-violet-500/90 text-white"
          >
            SIGN IN
